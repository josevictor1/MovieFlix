package com.dev.felipe.movieflix.UI;
...
import com.dev.felipe.movieflix.MainActivity;
import com.dev.felipe.movieflix.R;
import com.dev.felipe.movieflix.Retrofit.Movie;
import com.dev.felipe.movieflix.Retrofit.Discovery.MoviesAndTV;
import com.dev.felipe.movieflix.Utils.Common;
import com.dev.felipe.movieflix.Utils.OverviewFragment;
...
public class CardRecycleAdapter extends RecyclerView.Adapter<CardRecycleAdapter.CardViewHolder> {
    ...
    public class CardViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bindMovie(Movie movie) {
            ...
            mOverview.setText(overview.trim().length() == 0 ? ("Sem resultados para " + title + ".") : overview);

...
public class Search extends AppCompatActivity {
    ...
    public void searchText() {
        if (mSearchEditText.getText().toString().trim().length()>0) {
            ...
            mSearchProgress.setMessage("Pesquisando");
                                   ...
                                   if (searchResult.getResults().size()==0) {
                                       if (!mCreatedDialog) {
                                           AlertDialog.Builder noResults = new AlertDialog.Builder(Search.this)
                                                   .setTitle("Erro")
                                                   .setMessage("Não há filmes ou programas de TV que correspondam à sua consulta.\n\nTente novamente com uma consulta diferente.")
